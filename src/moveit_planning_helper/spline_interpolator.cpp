...
void SplineInterpolator::setSplineOrder(const unsigned int& order)
{
  if (m_order<5)
    m_order=order;
  else
...
bool SplineInterpolator::setTrajectory(const trajectory_msgs::JointTrajectory& trj)
{
  trajectory_msgs::JointTrajectoryPtr trj_ptr(new trajectory_msgs::JointTrajectory());
  *trj_ptr=trj;

  return setTrajectory(trj_ptr);
}

bool SplineInterpolator::setTrajectory(const trajectory_msgs::JointTrajectoryPtr& trj)
{
  if (!trj)
  {
...
bool SplineInterpolator::setTrajectory(const moveit_msgs::RobotTrajectoryPtr& trj)
{
  return setTrajectory(trj->joint_trajectory);
}

bool SplineInterpolator::setTrajectory(const moveit_msgs::RobotTrajectory &trj)
{
  return setTrajectory(trj.joint_trajectory);
}
...
ros::Duration SplineInterpolator::trjTime()
{
  if (m_trj)
...
bool SplineInterpolator::resampleTrajectory(const double delta_time, trajectory_msgs::JointTrajectory& trj)
{
  if (!m_trj)
    return false;
  ...
  double t=0;
  trj.points.clear();
  for (t=0;t<m_trj->points.back().time_from_start.toSec();t+=delta_time)
  {
    trajectory_msgs::JointTrajectoryPoint pnt;
    if (!interpolate(ros::Duration(t),pnt))
      return false;
    trj.points.push_back(pnt);
  }
  trajectory_msgs::JointTrajectoryPoint pnt;
  if (!interpolate(m_trj->points.back().time_from_start,pnt))
    return false;
  trj.points.push_back(pnt);
  return true;
}

bool SplineInterpolator::resampleTrajectory(const double delta_time, moveit_msgs::RobotTrajectory& trj)
{
  trajectory_msgs::JointTrajectory trajectory;
  bool success = resampleTrajectory(delta_time, trajectory);
  trj.joint_trajectory = trajectory;
